...
08/11/16  v1.7    Jack Stuart   Updated core Hallengren script to latest version (07 Oct 2016). SQL 2016 support and Added support availability groups in DatabaseBackup, DatabaseIntegrityCheck, and IndexOptimize, using a new parameter, @AvailabilityGroups.
...
BEGIN
 ...
 --- WardyIT Solutions ---
  ...
  SET @JobDescription01 = 'Performs a full backup of all system databases. WARDY IT SOLUTIONS 2015 (v1.7)'
  SET @JobDescription02 = 'Performs a differential backup of all user databases. WARDY IT SOLUTIONS 2015 (v1.7)'
  SET @JobDescription03 = 'Performs a full backup of all user databases. WARDY IT SOLUTIONS 2015 (v1.7)'
  SET @JobDescription04 = 'Performs a transaction log backup of all user databases. WARDY IT SOLUTIONS 2015 (v1.7)'
  SET @JobDescription05 = 'Performs an integrity check of all system databases. WARDY IT SOLUTIONS 2015 (v1.7)'
  SET @JobDescription06 = 'Performs an integrity check of all user databases. WARDY IT SOLUTIONS 2015 (v1.7)'
  SET @JobDescription07 = 'Performs index maintenance of all user databases, including updating statistics. WARDY IT SOLUTIONS 2015 (v1.7)'
  SET @JobDescription08 = 'Performs a backup history cleanup. WARDY IT SOLUTIONS 2015 (v1.7)'
  SET @JobDescription09 = 'Purges the job history that are outside a specific date range. WARDY IT SOLUTIONS 2015 (v1.7)'
  SET @JobDescription10 = 'Performs a cleanup of all output files. WARDY IT SOLUTIONS 2015 (v1.7)'
  SET @JobDescription11 = 'Removes logs from the default master.dbo.CommandLog table that are outside a specific date range. WARDY IT SOLUTIONS 2015 (v1.7)'
  SET @JobDescription12 = 'Archives the current SQL Server log file and creates a new log file to store events. WARDY IT SOLUTIONS 2015 (v1.7)'
  SET @JobDescription13 = 'Performs an integrity check of all user and system databases. WARDY IT SOLUTIONS 2015 (v1.7)'
  SET @JobDescription14 = 'Performs weekly maintenance tasks for Command Log Cleanup, Cycle Error Log, Delete Backup History, Output File Cleanup and Purging the job history. WARDY IT SOLUTIONS 2015 (v1.7)'
  ...
  BEGIN
    EXECUTE msdb.dbo.sp_add_job @job_name = @JobName01, @description = @JobDescription01, @category_name = @JobCategory, @owner_login_name = @JobOwner, @enabled = 0
  ...
  BEGIN
    EXECUTE msdb.dbo.sp_add_job @job_name = @JobName03, @description = @JobDescription03, @category_name = @JobCategory, @owner_login_name = @JobOwner, @enabled = 0
  ...
  BEGIN
    EXECUTE msdb.dbo.sp_add_job @job_name = @JobName04, @description = @JobDescription04, @category_name = @JobCategory, @owner_login_name = @JobOwner, @enabled = 0
 ...
 -- END
  ...
  BEGIN
    EXECUTE msdb.dbo.sp_add_job @job_name = @JobName07, @description = @JobDescription07, @category_name = @JobCategory, @owner_login_name = @JobOwner, @enabled = 0
 ...
 -- END
  ...
  BEGIN
    EXECUTE msdb.dbo.sp_add_job @job_name = @JobName13, @description = @JobDescription13, @category_name = @JobCategory, @owner_login_name = @JobOwner, @enabled = 0
  ...
  BEGIN
    EXECUTE msdb.dbo.sp_add_job @job_name = @JobName14, @description = @JobDescription14, @category_name = @JobCategory, @owner_login_name = @JobOwner, @enabled = 0
